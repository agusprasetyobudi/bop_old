<?php
class bukubank_model extends CFModels
{
	public function cfs()
	{
		parent::Boot();
	...
	{
		return $this->_Insert('#__buku_bank',$data);
	}
	...
	{
		return $this->_Get("SELECT * FROM #__buku_bank WHERE id_item_transfer='$id'");
	}
	public function tDebetSum($id)
	{
		return $this->_GetRow("SELECT IFNULL(SUM(total),0) total FROM #__buku_bank WHERE id_item_transfer='$id'");
	}
