<?php
class jabatan_controller extends CFControllers
{
	public function cfs()
	{
		parent::Boot();
	...
	{
		//breaad crumb
		$output['breadcrumb'] = array('jabatan'=>'Jabatan','list'=>'List Jabatan');
		
		//include template
		$output['content'] = 'jabatan/list.html';
	...
	public function listing()
	{
		...
		$aColumns = array( 'kode_jabatan', 'nama_jabatan','posisi_kantor','1');
		$sIndexColumn = "id";
		...
		$data = $this->model()->getPaging("SELECT kode_jabatan, nama_jabatan,posisi_kantor,1 FROM #__jabatan $sWhere $sOrder",$limit_length,$limit_start);
